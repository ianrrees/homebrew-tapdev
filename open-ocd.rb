class OpenOcd < Formula
  ...
  def install
    inreplace buildpath/"configure.ac", "AX_CONFIG_SUBDIR_OPTION([jimtcl], [--disable-install-jim --with-ext=\"eventloop array clock regexp stdlib tclcompat\" --without-ext=\"default\"])", "AX_CONFIG_SUBDIR_OPTION([jimtcl], [--disable-install-jim])"
